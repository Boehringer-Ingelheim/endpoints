...
Now we use `makeData()` to generate the subject-level dataset, where each
subject has their latent random effects generated. In this example, we cap
subject-level follow-up at 4 time units:
