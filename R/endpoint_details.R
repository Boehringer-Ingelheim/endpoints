...
#'   \item time-to-event.
#' }
#' Aliases such as \code{"normal"}, \code{"gaussian"}, \code{"bin"},
#' \code{"nb"}, \code{"zinb"}, and \code{"tte"} may also be accepted by the
#' package's internal normalization routines.
#'
#' @section General structure:
#' For \eqn{p} endpoints, \code{endpoint_details} should be a list of length
#' \eqn{p}:
#' \preformatted{
...
#' )
#' }
#' Each \code{ep_j} is a named list containing the parameters for endpoint
#' \eqn{j}.
#'
...
#' \describe{
#'   \item{endpoint_type}{
#'     Set to \code{"continuous"} or a recognized alias such as
#'     \code{"normal"}.
#'   }
#'   \item{baseline_mean}{
...
#'   }
#'   \item{sd}{
#'     Numeric scalar or numeric vector. If scalar, a common SD is used across
#'     all arms. If vector, it must have length equal to the total number of
#'     arms.
#'   }
#'   \item{trt_effect}{
...
#'     otherwise the length must be \code{K - 1}, where \code{K} is the total
#'     number of arms. If \code{NULL}, only data for the control group is
#'     generated. If \code{NULL} and \code{arm_mode = "full"}, \code{trt_effect}
#'     is taken to be 0 for all active arms.
#'   }
#' }
#'
...
#'   }
#'   \item{baseline_prob}{
#'     Numeric scalar in \code{(0, 1)} giving the control-group event
#'     probability.
#'   }
#'   \item{trt_prob}{
...
#'   }
#'   \item{trt_effect}{
#'     Optional. Numeric scalar or vector giving treatment-group effects on the
#'     log-odds scale.
#'   }
#' }
#'
...
#'   }
#'   \item{p_zero}{
#'     Optional. Numeric scalar in \eqn{[0,1]} giving the structural-zero
#'     probability. If omitted, defaults to 0.
#'   }
#' }
#'
#' Exactly one of \code{trt_count} or \code{trt_effect} may be supplied. In the
#' parameterization used, the variance is \eqn{\mu + \frac{\mu^2}{\phi}}, where
#' \code{size} controls \eqn{\phi}. The \code{p_zero} parameter is independent
#' of the copula.
#'
...
#' \describe{
#'   \item{endpoint_type}{
#'     Set to \code{"time-to-event"} or a recognized alias such as
#'     \code{"tte"}.
#'   }
#'   \item{baseline_rate}{
#'     Numeric scalar (> 0) giving the control-group exponential event-rate
#'     parameter \eqn{\lambda}. The mean event time is therefore
#'     \eqn{1/\lambda}.
#'   }
#' }
#'
...
#' Optionally, users may use \code{arm_mode} in \code{\link{makeData}}, but
#' this option should be used with care.
#'
#' @section Internal endpoint naming:
#' In the returned dataset, endpoints are automatically renamed by type:
#' \describe{
#'   \item{Continuous}{
#'     \code{Cont_1}, \code{Cont_2}, \dots
#'   }
#'   \item{Binary}{
#'     \code{Bin_1}, \code{Bin_2}, \dots
#'   }
#'   \item{Count}{
#'     \code{Int_1}, \code{Int_2}, \dots
#'   }
#'   \item{Time-to-event}{
#'     \code{TTE_1}, \code{TTE_2}, \dots
#'   }
#'   \item{TTE event indicators}{
#'     \code{Status_1}, \code{Status_2}, \dots, where \code{1 = event} and
#'     \code{0 = censored}
#'   }
#' }
#'
