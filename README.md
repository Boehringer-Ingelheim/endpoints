...
arms, censoring, stochastic enrollment, subject-level follow-up limits,
and trial-ending rules. The package is designed to produce realistic
patient-level datasets with configurable treatment effects, dependence
structures, and trial-calendar features for trial planning and
simulation studies.
...
- Subject-level follow-up limits and trial-ending rules, including fixed
  calendar end, last-patient-minimum-follow-up, and event-driven
  designs
