...
Now we use
[`makeData()`](https://boehringer-ingelheim.github.io/endpoints/reference/makeData.md)
to generate the subject-level dataset, where each subject has their
latent random effects generated. In this example, we cap subject-level
follow-up at 4 time units:
...
```
    ...
    ##    Data: long_rf_data_test
    ## 
    ## REML criterion at convergence: 54510.2
    ## 
    ## Scaled residuals: 
    ##     Min      1Q  Median      3Q     Max 
    ## -3.7939 -0.6437  0.0043  0.6447  3.9195 
    ## 
    ## Random effects:
    ##  Groups   Name        Variance Std.Dev. Corr 
    ##  ID       (Intercept) 0.26111  0.5110        
    ##           time        0.07656  0.2767   0.22 
    ##  Residual             0.99914  0.9996        
    ## Number of obs: 18000, groups:  ID, 2000
    ## 
    ## Fixed effects:
    ##             Estimate Std. Error t value
    ## (Intercept) 10.02791    0.02527 396.832
    ## trt          0.01111    0.03574   0.311
    ## time        -0.51202    0.01852 -27.647
    ## trt:time     0.98381    0.02619  37.562
...
| ID | TTE_1 | TTE_2 | Cont_1 | Cont_2 | trt | Status_1 | Status_2 | enrollTime | availableFollowup | time | linPred | response |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 0.00 | 10.606900 | 9.400602 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 0.25 | 10.645208 | 9.023166 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 0.50 | 10.683515 | 10.317673 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 0.75 | 10.721823 | 10.623685 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 1.00 | 10.760131 | 9.926915 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 1.25 | 10.798438 | 11.023809 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 1.50 | 10.836746 | 8.744633 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 1.75 | 10.875054 | 11.217336 |
| 1 | 4.0000000 | 0.3954673 | 0.6069000 | 0.6532307 | 0 | 0 | 1 | 0 | 4 | 2.00 | 10.913361 | 11.875564 |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 0.00 | 9.749710 | 9.641089 |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 0.25 | 9.688822 | 8.842817 |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 0.50 | 9.627934 | 8.110577 |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 0.75 | 9.567045 | 11.857615 |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 1.00 | 9.506157 | NA |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 1.25 | 9.445269 | NA |
| 2 | 0.9638439 | 0.5494779 | -0.2502899 | 0.2564471 | 0 | 0 | 1 | 0 | 4 | 1.50 | 9.384381 | NA |
